...
BEGIN
    ...
    BEGIN TRY
       ...
       --Data Loading Table-2
		...
		PRINT'--------------------------------------------------';
		PRINT'TOTAL SILVER LAYER LOADED TIME';
		PRINT' Loaded Time:' + CAST(DATEDIFF(SECOND, @start_batch_time, @end_batch_time) AS NVARCHAR) + ' seconds';
		PRINT'--------------------------------------------------';
	END TRY
	BEGIN CATCH
	    PRINT'==================================================';
